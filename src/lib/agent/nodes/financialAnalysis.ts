...
Return financial data as a single raw JSON object.
...
Fill all fields. If not in search results, use your own training knowledge. Score is 1-10 based on financial health.`
      },
      {
        role: 'user',
    ...
    const financialAnalysis: FinancialAnalysis = parseJSON<FinancialAnalysis>(content);
